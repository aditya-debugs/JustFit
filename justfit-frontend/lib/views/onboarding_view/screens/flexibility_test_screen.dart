...
class FlexibilityTestScreen extends StatefulWidget {
  ...
  @override
  State<FlexibilityTestScreen> createState() => _FlexibilityTestScreenState();
}

class _FlexibilityTestScreenState extends State<FlexibilityTestScreen>
  ...
  final List<Map<String, dynamic>> _options = [
    {
      ...
      'title': 'Far from my feet',
      'messageTitle': 'Don\'t worry!',
      'message': '75% of users lack flexibility. We will select suitable workouts to help you with it.',
    },
    {
      'value': 'close',
      'icon': Icons.accessibility_new,
      'title': 'Close to my feet',
      'messageTitle': 'Cool!',
      'message': '80% of users face the same as you. We will have a clear plan that is easy to follow.',
    },
    {
      'value': 'touch',
      'icon': Icons.accessibility_new,
      'title': 'Easily touch my feet',
      'messageTitle': 'Wow, impressive!',
      'message': 'Your flexibility is better than 75% of users, keep it up!',
    },
  ];
  ...
  void initState() {
    ...
    _selectedOption = _controller.flexibilityTest.value;
  ...
  void _handleNext() {
    if (_selectedOption != null && widget.onNext != null) {
      ...
      _controller.setFlexibilityTest(_selectedOption!);
      print('Flexibility test answer selected: $_selectedOption');
      widget.onNext!();
    }
  }
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'How far could you do a seated forward bend?',
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 24.0),
                child: Text(
                  'According to the Physical Activity Guidelines, this will help test your flexibility.',
                  style: GoogleFonts.poppins(
                    fontSize: 14,
