...
class GoalAchievementFeelingsScreen extends StatefulWidget {
  ...
  const GoalAchievementFeelingsScreen({
    Key? key,
    required this.partTitle,
    this.currentPart = 4,
    this.currentQuestionInPart = 12,
  ...
  @override
  State<GoalAchievementFeelingsScreen> createState() =>
      _GoalAchievementFeelingsScreenState();
}

class _GoalAchievementFeelingsScreenState
    extends State<GoalAchievementFeelingsScreen>
  ...
  final List<Map<String, dynamic>> _options = [
    {'icon': Icons.auto_awesome, 'label': 'Being proud of myself'},
    {'icon': Icons.thumb_up_outlined, 'label': 'Feeling great'},
    {'icon': Icons.favorite_outline, 'label': 'Believe in myself'},
    {
      'icon': Icons.bolt,
      'label': 'Feel empowered to make healthy choices'
    },
    {
      'icon': Icons.sentiment_satisfied_alt,
      'label': 'Worry less about my body overall'
    },
  ];
  ...
  void initState() {
    ...
    _selectedOption = _controller.goalAchievementFeeling.value;
  ...
  void _handleNext() {
    if (_selectedOption != null && widget.onNext != null) {
      ...
      _controller.setGoalAchievementFeeling(_selectedOption!);
      print('Goal achievement feeling selected: $_selectedOption');
      widget.onNext!();
    }
  }
